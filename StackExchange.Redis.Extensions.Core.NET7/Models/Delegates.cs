...
namespace StackExchange.Redis.Extensions.Core.NET7.Models;
...
public delegate IStateAwareConnection StateAwareConnectionResolver(IConnectionMultiplexer connectionMultiplexer,
    ILogger logger);