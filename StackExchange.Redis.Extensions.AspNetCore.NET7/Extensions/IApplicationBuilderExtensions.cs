...
using StackExchange.Redis.Extensions.AspNetCore.NET7.Middlewares;
...
public static class IApplicationBuilderExtensions
{
    ...
    public static IApplicationBuilder UseRedisInformation(this IApplicationBuilder application,
        Action<RedisMiddlewareAccessOptions>? options = null)
    {
